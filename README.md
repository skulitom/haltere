...
An [offline navigation experiment](docs/navigation_training.md) trains a causal
path predictor and compares vision with motion-only and kinematic baselines.
