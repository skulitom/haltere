...
This release was evaluated offline and used as a training teacher. The
[project direction clarified on 2026-09-22](project_direction.md) also permits
runtime navigation prediction. These particular weights have not demonstrated
a closed-loop flight benefit; the release results below remain offline results.
